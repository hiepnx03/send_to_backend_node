# Hướng Dẫn Sử Dụng Node

Chào mừng bạn đến với tài liệu hướng dẫn cho bộ node **Send To Backend & API Trigger**.

## Danh Sách Hướng Dẫn
- [APITrigger (Dynamic)](APITrigger.md): Điểm bắt đầu cho các cuộc gọi API từ bên ngoài.
- [Get Data From API](GetFromAPI.md): Trích xuất các trường dữ liệu cụ thể từ API.
- [API Response (Sync Out)](ApiResponse.md): Trả kết quả trực tiếp cho người gọi HTTP.
- [Automated Webhook](WebhookNode.md): Tự động gửi kết quả đến URL bên ngoài.
